...
\[
\gamma(i,j)= & \;-\hspace{-6pt}\sum_{1\leq l < l' \leq K}
    \begin{cases}
      h(a_{l i},a_{l' i}) + h(a_{l j},a_{l' j}) & \text{$a_{l i} - a_{l j}$, $a_{l' i} - a_{l' j}$ compl.}\\
      0 & \text{otherwise},
    \end{cases}
    \\&+\delta\sum_{1\leq l \leq K}
    \begin{cases}
      0 & \text{$a_{l i} - a_{l j}$ complementary}\\
      0.25 & \text{$a_{l i}, a_{l j}$ are both gaps}\\ \\
      1 & \text{otherwise},
    \end{cases}
\]
:::
