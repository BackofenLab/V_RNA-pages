...
In the following, we refer to them via $ED(B_1)$ and $ED(B_2 \mid B_1)$. Similarly, we denote respective energy $E$ and hybridization energy $E_hyp$ terms.
...
To show that the equality holds, we used the following tricks to reformulate the left side of equation \ref{Ecombined} into the right side:
