...
Compute the expected value of the information of the radome variable $E[I(X)]$ or entropy $H(X)$ as described above. 
...
::: {.answer data-latex=""}
How can you ensure that the open chain gets the lowest Bolzman weight without changing the idea to score the number of base pairs for computing the energy of a structure?
