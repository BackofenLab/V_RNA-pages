...
knitr::include_graphics("../assets/figures/exercise-sheet-0/exercise1-sol.jpeg")
```
...
```{r, include=knitr::is_html_output(), echo=FALSE,}
knitr::include_graphics("../assets/figures/exercise-sheet-0/exercise2-sol.jpeg")
```
...
1% DNA -to- protein, 80 - 90% DNA -to- RNA
