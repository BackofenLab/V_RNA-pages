...
Run the [http://rna.tbi.univie.ac.at/cgi-bin/RNAWebSuite/RNAfold.cgi](server) using the sample sequence.

Feed the sequence-structure pair into the [http://rna.tbi.univie.ac.at/cgi-bin/RNAWebSuite/RNAeval.cgi](Vienna RNAeval WebServer) and compare your decomposition with the resulting one.
