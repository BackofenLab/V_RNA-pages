...
knitr::include_graphics("assets/figures/exercise-sheet-6/e2-2.svg")
```
...
```{r, include=knitr::is_html_output(), echo=FALSE,  fig.align='center', out.width='75%'}
knitr::include_graphics("assets/figures/exercise-sheet-6/e2-3.svg")
```
...
knitr::include_graphics("assets/figures/exercise-sheet-6/e3-1.svg")
```
...
```{r, include=knitr::is_html_output(), echo=FALSE,  fig.align='center', out.width='60%'}
knitr::include_graphics("assets/figures/exercise-sheet-6/e3-2.svg")
```

Alignment:

```{r, include=knitr::is_html_output(), echo=FALSE,  fig.align='center', out.width='40%'}
knitr::include_graphics("assets/figures/exercise-sheet-6/e3-3.svg")
```
