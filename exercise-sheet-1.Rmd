...
a.
    * N_{1,8} → N_{1,1}+N_{2,8}
    * N_{1,1} → STOP
    * N_{2,8} → N_{2,4}+N_{5,8}
    * N_{2,4} → N_{3,3}+bp (2,4)
    * N_{3,3} → STOP
    * N_{5,8} → N_{5,7}+N_{8,8}
    * N_{5,7} → N_{6,6}+bp (5,7)
    * N_{6,6} → STOP
    * N_{8,8} → STOP
b.
    * N_{1,8} → N_{1,1}+N_{2,8}
    * N_{1,1} → STOP
    * N_{2,8} → N_{2,7}+N_{8,8}
    * N_{2,7} → N_{2,4}+N_{5,7}
    * N_{2,4} → N_{3,3}+bp (2,4)
    * N_{3,3} → STOP
    * N_{5,7} → N_{6,6}+bp (5,7)
    * N_{6,6} → STOP
    * N_{8,8} → STOP
c.
    * N_{1,8} → N_{1,4}+N_{5,8}
    * N_{1,4} → N_{1,1}+N_{2,4}
    * N_{1,1} → STOP
    * N_{2,4} → N_{3,3}+bp (2,4)
    * N_{3,3} → STOP
    * N_{5,8} → N_{5,7}+N_{8,8}
    ...
    * N_{8,8} → STOP
d.
    * N_{1,8} → N_{1,7}+N_{8,8}
    * N_{1,7} → N_{1,1}+N_{2,7}
    * N_{1,1} → STOP
    * N_{2,7} → N_{2,4}+N_{5,7}
    * N_{2,4} → N_{3,3}+bp (2,4)
    * N_{3,3} → STOP
